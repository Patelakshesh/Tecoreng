        ...
        <div className=" c-30">
          <ul className="servicesSection">
            ...
            >
                ...
                <div className="content-left">
                  ...
                  <div className="content-services">
                    ...
                    <div
                      ...
                      style={{
                        display: hoveredIndex === true ? "flex" : "none",
                      }}
                    >
                      Transform your business concepts with our web development
                      services, crafting innovative and next-generation
                      websites.
                    </div>
                  </div>
                </div>
              ...
              <div
                className="content-serviceImgs"
                style={{ display: hoveredIndex === true ? "flex" : "none" }}
              >
              ...
              <a aria-label="Web Development" href="/web-development-company">
                ...
                >
                  ...
                  >
                    <path
                      d="M20.9791 8.55562C21.3696 8.16509 21.3696 7.53193 20.9791 7.1414L14.6152 0.777442C14.2246 0.386917 13.5915 0.386917 13.2009 0.777442C12.8104 1.16797 12.8104 1.80113 13.2009 2.19166L18.8578 7.84851L13.2009 13.5054C12.8104 13.8959 12.8104 14.5291 13.2009 14.9196C13.5915 15.3101 14.2246 15.3101 14.6152 14.9196L20.9791 8.55562ZM0.726563 8.84851L20.272 8.84851L20.272 6.84851L0.726562 6.84851L0.726563 8.84851Z"
                      fill="white"
                    ></path>
                  </svg>
                </div>
            ...
            >
                ...
                <div className="content-left">
                  ...
                  <div className="content-services">
                    ...
                    <div
                      className="serviceDesc"
                      style={{
                        display: mobileHover === true ? "flex" : "none",
                      }}
                    >
                      Drive digital evolution by creating scalable, compelling,
              ...
              <div
                className="content-serviceImgs"
                style={{ display: mobileHover === true ? "flex" : "none" }}
              >
                <div className="serviceImgBox">
                  <img
                    alt="android"
            ...
            >
                ...
                <div className="content-left">
                  ...
                  <div className="content-services">
                    ...
                    <div
                      className="serviceDesc"
                      style={{
                        display: graphicsHover === true ? "flex" : "none",
                      }}
                    >
                      Through our creatively inspired and strategically guided
                      solutions, we assist your brand in establishing emotional
              ...
              <div
                className="content-serviceImgs"
                style={{ display: graphicsHover === true ? "flex" : "none" }}
              >
                <div className="serviceImgBox">
                  <img
                    alt="android"
            ...
            >
                ...
                <div className="content-left">
                  ...
                  <div className="content-services">
                    ...
                    <div
                      className="serviceDesc"
                      style={{
                        display: designHover === true ? "flex" : "none",
                      }}
                    >
                      We specialise in crafting professional and creative
                      websites. Our designers create websites that are both
              ...
              <div
                className="content-serviceImgs"
                style={{ display: designHover === true ? "flex" : "none" }}
              >
                <div className="serviceImgBox">
                  <img
                    alt="android"
            ...
            >
                ...
                <div className="content-left">
                  ...
                  <div className="content-services">
                    ...
                    <div
                      className="serviceDesc"
                      style={{
                        display: qualityHover === true ? "flex" : "none",
                      }}
                    >
                      Explore our user-friendly and seamless website and app
                      development services, designed for easy management.
                    </div>
                  </div>
                </div>
              </a>
              <div
                className="content-serviceImgs"
                style={{ display: qualityHover === true ? "flex" : "none" }}
              >
                <div className="serviceImgBox">
                  <img
                    alt="android"
            ...
            >
                ...
                <div className="content-left">
                  ...
                  <div className="content-services">
                    ...
                    <div
                      className="serviceDesc"
                      style={{
                        display: digitalHover === true ? "flex" : "none",
                      }}
                    >
                      Leverage our digital marketing services to achieve
                      outstanding sales conversions and maximise ROI.
                    </div>
                  </div>
                </div>
              </a>
              <div
                className="content-serviceImgs"
                style={{ display: digitalHover === true ? "flex" : "none" }}
              >
                <div className="serviceImgBox">
                  <img
                    alt="android"
