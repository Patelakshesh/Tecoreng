...
const ContactForm = () => {
  ...
  const validate = () => {
    ...
    } else if (formData.contactUsNumber.length < 10 || formData.contactUsNumber.length > 15) {
      newErrors.contactUsNumber = 'Must be between 10 and 15 digits';
    }
    if (!formData.contactUsMessage) newErrors.contactUsMessage = 'Message is required';
    if (formData.contactUsFile && formData.contactUsFile.size > 2 * 1024 * 1024) {
  ...
  return (
    <section className="sc-4a22d054-3 hmJVvh">
      <div className="container" id="contactForm">
        <div className="a-87 dhSeqm position-relative">
          <div className="row">
            <div className="col-lg-6 d-none d-lg-block left-side-section">
              <div className="title">We Are Here To Help You</div>
              <div className="form-description">Let’s Transform Your Vision Into Value.</div>
              ...
              <div className="tecoreng-skype">
                ...
                <p className="m-0" style={{ paddingTop: '6px' }}>
                  <a href="skype:live:.cid.a1e2fe8f7d36b5e8?call">biz.tecoreng</a>
                </p>
              </div>
                ...
                <div className="container">
                  <div className="row align-items-center">
                    <div className="col-12">
                      <h2>Our Socials</h2>
                      <p className="d-none d-md-flex">Don’t Miss To Follow Us On Our Social Networks Accounts.</p>
                    </div>
                    <div className="col-8">
            ...
            <div className="col-lg-6">
              <div className="sc-4a22d054-5 LkOYh">
                <div className="title">
                  <h2>Get in <span className="gradientText">touch</span></h2>
                  <p>We are always ready to help. There are many ways to contact us. You may drop us a line, give us a call, send an email.</p>
                </div>
                <form onSubmit={handleSubmit} encType="multipart/form-data">
                  <div className="form-group">
                    <input
                      ...
                      name="contactUsName"
                      className="sc-4a22d054-6 iebPxU"
                      value={formData.contactUsName}
                      onChange={handleChange}
                    />
                    {errors.contactUsName && <div className="error-message">{errors.contactUsName}</div>}
                  </div>
                  ...
                  {errors.contactUsNumber && <div className="error-message">{errors.contactUsNumber}</div>}
                  ...
                  <div className="form-group">
                    <input
                      ...
                      onChange={handleChange}
                    />
                    {errors.contactUsEmail && <div className="error-message">{errors.contactUsEmail}</div>}
                  </div>
                  ...
                  <div className="form-group">
                    <textarea
                      ...
                      onChange={handleChange}
                    />
                    {errors.contactUsMessage && <div className="error-message">{errors.contactUsMessage}</div>}
                  </div>
                  ...
                  <div className="form-group">
                    <label className="fileUpload">
                      ...
                      <span className="additional-file">
                        {formData.contactUsFile?.name || 'Upload Additional file'}
                      </span>
                      <input
                        type="file"
                        name="contactUsFile"
                    ...
                    {errors.contactUsFile && <div className="error-message">{errors.contactUsFile}</div>}
